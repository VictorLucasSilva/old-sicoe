...
def overview_attachment_create(request, document, center):
    ...
    if request.method == "POST":
        if not enforce_content_type(request, form_paths=('/gerente-regional/',), allow_multipart=True):
        ...
        if not form.is_valid():
            ...
            return render(request, 'main/gerente/overview_attachment_create.html', context)
